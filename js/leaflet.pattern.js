    ...
    L.Pattern=L.Class.extend({
        ...
        initialize:function(t){
            ...
            setStyle:function(t){
                ...
                this._map&&(this._updateStyle(),this.redraw()),this
            },
            addTo:function(t){
                return t.addPattern(this),
                this
            },
            remove:function(){
        ...
        L.Map.include({
            ...
            removePattern:function(t){
                var e=L.stamp(t);
                return this._patterns[e]?(this._loaded&&t.onRemove(this),
                t.getEvents&&this.off(t.getEvents(),t)
                ,delete this._patterns[e],this._loaded&&(this.fire("patternremove",{pattern:t}),
                t.fire("remove")),
                t._map=null,this):this
            },
        ...
        L.Pattern=L.Pattern.extend({_createElement:function(t){
        ...
        _initDom:function(){
            ...
            _removeDom:function(){
                ...
                e=this.options;
                if(t){
                    if(t.setAttribute("id",L.stamp(this)),
                    ...
                    t.removeAttribute("patternTransform");
            ...
            _initDefRoot:function(){
                ...
                L.SVG?L.SVG.include({
                    ...
                    _updateStyle:function(t){
                        ...
                        t.options.fill&&t.options.fillPattern&&t._path.setAttribute("fill","url(#"+L.stamp(t.options.fillPattern)+")")
                    }
                }):L.Path.include({
                    _superUpdateStyle:L.Path.prototype._updateStyle,
                    _updateStyle:function(){
                        this._superUpdateStyle(),
                        this.options.fill&&this.options.fillPattern&&this._path.setAttribute("fill","url(#"+L.stamp(this.options.fillPattern)+")")
                    }
                }),
                L.StripePattern=L.Pattern.extend({
                    ...
                    L.PatternShape=L.Class.extend({
                        ...
                        addTo:function(t){
                            return t.addShape(this),
                            this
                        },
                        redraw:function(){
                            return this._pattern&&this._updateShape(),
                            this
                        },
                        setStyle:function(t){
                            return L.setOptions(this,t),
                    ...
                    L.PatternCircle=L.PatternShape.extend({
                        ...
                        _updateShape:function(){
                            this._dom&&(this._dom.setAttribute("cx",this.options.x),
                    ...
                    L.PatternRect=L.PatternShape.extend({
                        ...
                        _updateShape:function(){
                            this._dom&&(this._dom.setAttribute("x",this.options.x),
